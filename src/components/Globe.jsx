...
export default function Globe({
  baseColor = [0.15, 0.12, 0.05], // Tono dorado oscuro
  markerColor = [253 / 255, 229 / 255, 171 / 255], // #fde5ab en dorado
  glowColor = [0.99, 0.9, 0.67], // Tono dorado claro #fde5ab
  markers = [
    { location: [-34.9011, -56.1645], size: 0.08 }, // Montevideo, Uruguay
  ],
  scale = 1,
      ...
      globeRef.current = createGlobe(canvasRef.current, {
        ...
        onRender: (state) => {
          ...
          if (autoRotate && !pointerInteracting.current && !focusRef.current) {
            phiRef.current += 0.003; // Velocidad reducida para rotación más lenta
          }
